...
from data.common import split_generators
...
class OKVQAConfig(datasets.BuilderConfig):
    ...
    def __init__(self, images_dir=None, answer_selector=None, verbose=True, **kwargs):
...
class OKVQADataset(datasets.GeneratorBasedBuilder):
    ...
    def _generate_examples(self, questions_path, annotations_path, images_path):
        ...
        for question in questions["questions"]:
            ...
            record["answer"] = self.config.answer_selector(record["answers"])

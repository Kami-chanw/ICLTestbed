...
🚨 If you want to replace official evaluation, you should add a test script in `test/` to prove that your code is consistent with official code.
...
3. Implement `process_input`. This method convert conversations to actual context and process it with `processor`s of `transformers`.